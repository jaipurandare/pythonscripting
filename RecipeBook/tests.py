import unittest
from solution import RecipeBook, Recipe, Instruction
...
class TestRecipeBook(unittest.TestCase):
    ...
    def test_search_by_name_returns_all_containing_query(self):
        instruction = Instruction(1,"Cook it", 0, "pan")
        pasta = Recipe("pasta", [], [instruction])
        omlet = Recipe("omlet", [], [instruction])
        macaroni_pasta = Recipe("macaroni pasta", [], [instruction])
